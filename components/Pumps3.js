...
function Pumps3() {
	return (
		<Row className=" text-center justify-content-center align-items-center vh-full shadow-lg my-2 light ">
			<Col xl={5} lg={5} className="blur p-3 mx-2 shadow-lg ">
				...
				>
					<Card.Body className="text-center">
						<p className="lead">
							{" "}
							Haiers Heat Pump Water Heater series was developed with household
							energy savings in mind. Unlike a traditional water heater, heat
							pump water heaters provide hot water using the heat in the air,
							saving on the energy consumption.
						</p>
						<Nav.Link
							as={Link}
